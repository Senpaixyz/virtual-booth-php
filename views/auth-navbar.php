<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-800">
    <div class="container flex flex-wrap items-center justify-end md:justify-between lg:justify-between xl:justify-between mx-auto">
        ...
        <div class="flex  md:order-2">
            <p class="text-xs text-gray-900 dark:text-gray-300 mr-3 hidden  lg:block xl:block ">Back to PLAS-PSH 2023 Main Hall</p>
...
<!-- 
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            ...
            <ul class="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-800 dark:border-gray-800">
                <li>
                    <a href="javascript:void(0)"  class="modal-button block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">VIRTUAL BOOTH</a>
                </li>
                <li>
                ...
                <li>
                    <a  href="javascript:void(0)" data-target="#panel-video-modal"  class="modal-button block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">VIDEOS</a>
                </li>
                <li>
                    <a  href="javascript:void(0)" data-target="#panel-records-modal"  class="modal-button block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">RECORDS</a>
                </li>
            </ul>
        </div>
